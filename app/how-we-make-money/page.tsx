...
export const metadata = {
  ...
  description: "TimeScout revenue model — honest and plain.",
};
        ...
        <section className="relative overflow-hidden rounded-3xl border border-neutral-200 bg-gradient-to-br from-white to-accent-softer p-8 shadow-sm transition duration-300 hover:shadow-md sm:p-10">
          ...
          <div className="relative">
            ...
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl">
              How TimeScout makes money
            </h1>
            <p className="mt-4 max-w-3xl text-sm leading-relaxed text-neutral-700 sm:text-base">
              The goal is transparent, low-friction monetization. We want this page to stay plain and
              specific, not legal theater.
            </p>
          </div>
        </section>

        <section className="mt-8 grid gap-4 sm:grid-cols-3">
          <InfoCard title="Current status" body="No active monetization yet. Outbound clicks are logged for product analytics only." />
          <InfoCard title="Likely model" body="Affiliate or referral fees from marketplaces when a user buys after clicking out." />
          <InfoCard title="Non-goals" body="No paid listing placements disguised as organic search results." />
        </section>

        <section className="mt-10 rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
          <h2 className="text-xl font-semibold tracking-tight text-neutral-900">What will be disclosed</h2>
          <ul className="mt-4 space-y-3 text-sm leading-relaxed text-neutral-600">
            <li>
              <strong className="font-semibold text-neutral-800">Programs in use:</strong> each active affiliate/referral partner will be listed here.
            </li>
            <li>
              <strong className="font-semibold text-neutral-800">How links are tagged:</strong> we&apos;ll describe attribution at a high level, with no hidden behavior.
            </li>
            <li>
              <strong className="font-semibold text-neutral-800">Ranking policy:</strong> search ordering is utility-driven, not paid priority.
            </li>
          </ul>
        </section>

        <section className="mt-8 rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
          <h2 className="text-xl font-semibold tracking-tight text-neutral-900">Why this approach</h2>
          <p className="mt-3 text-sm leading-relaxed text-neutral-600">
            TimeScout only works if users trust the index. The quickest way to lose trust is fuzzy
            monetization. This page exists so the business model stays explicit as the product grows.
          </p>
        </section>
